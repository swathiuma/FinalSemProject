...
String query1="select max(det_aptno) from dermatology";
String query2="insert into dermatology values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

ps1=con1.prepareStatement("select max(det_aptno) from dermatology");
...
{
ps2.setString(j,request.getParameter("det"+i));
}
int k=ps2.executeUpdate();
if(k>0)
	System.out.println(" successfully uploaded drt details..");
else
	out.println(" not successfully uploaded dermatology details..");
