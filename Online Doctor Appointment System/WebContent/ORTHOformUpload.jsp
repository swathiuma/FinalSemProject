...
String query1="select max(ort_aptno) from orthopedic";
String query2="insert into orthopedic values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

ps1=con1.prepareStatement("select max(ort_aptno) from orthopedic");
...
for(int i=1,j=6;i<=10;i++,j++)
{
ps2.setString(j,request.getParameter("ort"+i));
}
int k=ps2.executeUpdate();
if(k>0)
	System.out.println(" successfully uploaded ort details..");
else
	out.println(" not successfully uploaded ortopedic details..");
