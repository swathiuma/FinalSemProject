...
<body>
<%
System.out.println("patientprofile.jsp START");
ResultSet rs=null;
...
rs=DbConnector.getDataFromTable("patients", cond);
 rs.next(); 
%>
<button id="editbtn" type="submit" onclick="location.href='p_profileEdit.jsp'">Edit</button>
<br>
<table align="center">
...
<%
System.out.println("patientprofile.jsp ENDED...");
%>
</body>
</html>